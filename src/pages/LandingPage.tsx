    ...
    <div className="relative min-h-screen overflow-hidden">
      ...
      >
        ...
        <motion.button
          ...
          whileTap={{ scale: 0.98 }}
          className="relative px-6 py-2 rounded-full bg-gradient-to-r from-cyan-500 to-teal-500 text-white font-medium text-sm tracking-wide overflow-hidden shadow-lg shadow-cyan-500/25 transition-all duration-300"
        >
          Get Started
        </motion.button>
      </motion.nav>
